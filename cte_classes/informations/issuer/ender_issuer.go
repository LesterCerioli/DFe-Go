...
// enderEmit representa o endereço do emitente.
...
func (e *enderEmit) GetProxyCEP() string {
	return fmt.Sprintf("%08d", e.CEP)
}

// SetProxyCEP define o CEP a partir de uma string.
func (e *enderEmit) SetProxyCEP(value string) error {
	var err error
